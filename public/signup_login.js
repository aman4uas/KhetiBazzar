const cnfrm_pass = document.querySelector("#user-password-confirm");
const pass = document.querySelector("#user-password");

cnfrm_pass.addEventListener("keyup", (e)=>{
    if(cnfrm_pass.value !== pass.value){
        document.querySelector("#message-con").innerHTML = "*Password does not match";
    }
    else{
        document.querySelector("#message-con").innerHTML = "";
    }
})

pass.addEventListener("keyup", (e)=>{
    if(pass.value.length<8){
        document.querySelector("#message").innerHTML = "*Password must contain 8 characters or more";
    } else{
...
//     currentInputField.addEventListener('onkeyup', (e)=>{
